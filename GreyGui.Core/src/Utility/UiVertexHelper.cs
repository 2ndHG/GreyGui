...
{
    public static  (UiVertex[], int[]) GenerateTextVertices(List<GlyphInfo> glyphInfoList, Vector2 position, Color color, float fontSize)
    {
        ...
        foreach (GlyphInfo glyphInfo in CollectionsMarshal.AsSpan(glyphInfoList))
        {
